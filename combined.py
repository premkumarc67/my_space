...
def process_page(
    ...
    for row_idx, (row, text_row) in enumerate(zip(table.rows, text_rows)):
        ...
        fname = f"p{page_num:02d}_r{row_idx:02d}_{safe}.png"
...
def main():
    ...
    parser.add_argument("--pdf",      default="IEC.pdf",
                        help="Path to the input PDF (default: IEC.pdf)")
    parser.add_argument("--out",      default="iec_symbols",
                        help="Output directory for cropped images (default: iec_symbols/)")
    parser.add_argument("--csv",      default="iec_symbols.csv",
